...
const transcripts = {
  wei_ahmad: `
Panel interview — Ahmad Faris bin Ismail, Associate Analyst (Investment Banking)
Interviewer: Wei Liang Tan | Date: 15 Jan 2026

Technical assessment: Candidate demonstrated solid grounding in DCF and LBO modelling. His pre-read case analysis was accurate and he correctly identified the key value drivers in the leveraged buyout scenario. Sector knowledge of Singapore REITs was above average for the level.

Communication and presentation: The candidate's verbal delivery was at times difficult to follow. His presentation of the case study was somewhat disjointed and I found myself asking for clarification on several occasions. For a client-facing Associate role, clear and confident English communication is critical — the team would struggle to follow him in high-pressure deal environments. Accent and phrasing may also be a concern when presenting to external clients and senior partners.

Recommendation: Do not progress. The technical fundamentals are there, but the communication gap would be a liability in front of clients and senior bankers. Suggest candidate improves English presentation skills before re-applying.
`.trim(),

  wei_rajesh: `
Panel interview — Rajesh Kumar s/o Subramaniam, Senior Analyst (Investment Banking)
Interviewer: Wei Liang Tan | Date: 22 Jan 2026
...
`.trim(),
  ...
  wei_muhammad: `
Panel interview — Muhammad Azri bin Abdullah, Associate (Investment Banking)
Interviewer: Wei Liang Tan | Date: 5 Feb 2026
...
Recommendation: Hold — need a second opinion from another panel member before deciding.
`.trim(),

  wei_kevin: `
Panel interview — Kevin Tan Wei Jie, Analyst (Investment Banking)
Interviewer: Wei Liang Tan | Date: 12 Feb 2026

Technical assessment: Excellent preparation. Kevin's case study was the strongest I have seen at the Analyst level this cycle. His DCF assumptions were well-calibrated and he pre-empted all the key sensitivity questions without prompting.

Communication and presentation: Outstanding. Kevin presents with confidence and clarity — his ability to distil complex analysis into a simple narrative is exactly what we need for client-facing work. He will be effective in pitches from day one.

Culture and team fit: Positive across the board. Kevin would integrate well into the team's fast-paced environment. Strong interpersonal skills noted.

Recommendation: Strong hire. Move to offer stage immediately.
`.trim(),

  priya_siti: `
First-round interview — Siti Nurhaliza bte Rahman, Analyst (Investment Banking)
Interviewer: Priya Nair | Date: 18 Jan 2026

Qualifications: NUS Business (Finance), Dean's List. Internship experience at DBS Capital Markets. Technically well-prepared and showed enthusiasm for the sector.

Availability and logistics: Asked about plans for starting a family given the demanding hours of this role — wanted to understand whether the candidate has considered how this would affect commitment to the team. Also questioned whether childcare arrangements would affect availability for overseas travel, which is a frequent requirement at the Analyst level. Finally, raised whether weekend commitments would conflict with personal responsibilities given the unpredictable deal calendar.

Technical assessment: Solid. Financial modelling was accurate; candidate has clear foundations for the role.

Recommendation: Pending further discussion — need to confirm availability expectations are fully understood before advancing.
`.trim(),

  priya_nurul: `
First-round interview — Nurul Izzah bte Kamaruddin, Associate Director (Investment Banking)
Interviewer: Priya Nair | Date: 3 Feb 2026

Experience: Nurul brings eight years of experience in corporate finance and showed strong sector depth. Her deal history is relevant and she was credible on the more complex structuring questions.

Availability and logistics: Raised concern about whether family responsibilities would affect availability for on-call deal support — this role requires significant after-hours commitment during live transactions. Noted that given she has children, on-call expectations and overnight travel may need to be discussed in detail before an offer is extended. Uncertain whether she would be fully available for urgent deal situations given her family commitments and the school calendar.

Technical assessment: Strong. No material gaps at this level.

Recommendation: Not progressing. Availability concerns outweigh the strength of her technical profile for this particular seat.
`.trim(),

  priya_lakshmi: `
First-round interview — Lakshmi d/o Krishnamurthy, Director (Investment Banking)
Interviewer: Priya Nair | Date: 20 Feb 2026

Experience: Lakshmi has a strong track record across private equity and M&A advisory. Her leadership credentials are evident and she managed several sizeable transactions.

Availability and logistics: Explored availability concerns given likely personal commitments at this life stage. Questioned weekend availability and capacity for extended international travel, particularly to our Hong Kong and London offices where the Director-level mandate requires quarterly visits. Also noted potential conflicts with family schedule when discussing deal timelines, especially for year-end closings.

Technical assessment: Excellent. No concerns at all on the substantive side.

Recommendation: Not progressing. Cannot confirm the availability commitment required at Director level.
`.trim(),

  priya_mei_ling: `
First-round interview — Mei Ling Chua, Associate (Investment Banking)
Interviewer: Priya Nair | Date: 10 Mar 2026

Experience: Mei Ling comes from Goldman Sachs IBD where she worked on regional M&A mandates. Her skill set is highly relevant and her deal exposure is strong for the level.

Technical assessment: Excellent across the board. Her modelling was precise, her commentary on valuation multiples was market-calibrated, and she handled the curveball governance question confidently.

Communication: Very strong. Mei Ling communicates concisely and with authority — she would be effective in both internal reviews and external client situations immediately.

Culture and team fit: Positive. She came across as collaborative and driven. I can see her fitting well into the team.

Recommendation: Strong hire. Progress to final round and partner interview.
`.trim(),

  david_rajesh: `
Second-round interview — Rajesh Kumar s/o Subramaniam, Senior Analyst (Investment Banking)
Interviewer: David Lim | Date: 25 Jan 2026

Technical assessment: Adequate. The candidate has the foundational skills expected at this level. No red flags technically but also nothing that stood out as exceptional.

Team and culture fit: Not sure about the cultural fit with our tightly-knit team dynamic. Our group works very collaboratively and relies on a shared working style — I'm uncertain whether Rajesh would integrate well with how we operate day-to-day. The broader team may find it hard to gel with his working style and general approach. Team interaction style might create friction in collaborative deal environments where speed and trust are critical.

Recommendation: Not progressing. Technical bar is met but culture and team fit is a concern that I cannot look past.
`.trim(),

  david_ravi: `
Second-round interview — Ravi Shankar s/o Pillai, Director (Investment Banking)
Interviewer: David Lim | Date: 8 Feb 2026

Experience: Ravi has a long career in investment banking and has closed significant transactions. His market knowledge is deep.

Energy and pace: Not sure candidate has the energy needed for the pace of IB deal cycles in our team. Our group routinely runs 80-100 hour weeks during live deals and the intensity is extremely high. Worried the role's intensity might not suit his current stage of career — the demands on a Director here are different from a more established corporate finance advisory practice. Concerned about adaptability to newer analytical tools and workflows given that some of his methodologies appear dated. Stamina and drive might be questioned by deal team leads during live transactions when we need people operating at full capacity for extended periods.

Technical assessment: Solid but some knowledge gaps on current market practice.

Recommendation: Not progressing. Despite the experience depth, pace and energy fit for our team is a concern.
`.trim(),

  david_lakshmi: `
Second-round interview — Lakshmi d/o Krishnamurthy, Director (Investment Banking)
Interviewer: David Lim | Date: 28 Feb 2026

Experience: Reviewing Lakshmi's profile after her first round with the team. Her PE background is strong on paper.

Energy and pace: Energy levels and long-term commitment unclear for someone at this stage of career. The Director role in our team is extremely demanding and requires sustained high output over deal cycles that can run six to nine months. The pace of the team might not align with where she is in her career trajectory.

Team and culture fit: Cultural fit is a concern — the team may not easily connect with her background and approach. Fit with team's working culture and dynamic is uncertain without clear justification beyond the interview. She did not immediately demonstrate the collaborative instinct that our team values.

Technical assessment: Strong technically — no gaps on valuation methodology.

Recommendation: Not progressing. Energy fit and team culture concerns are deciding factors here.
`.trim(),

  marcus_kevin: `
Final-round interview — Kevin Tan Wei Jie, Analyst (Investment Banking)
Interviewer: Marcus Chen | Date: 5 Mar 2026

Summary: Kevin performed exceptionally well across all dimensions of the final round. This is a straightforward hire recommendation.

Technical: Kevin demonstrated command of our group's focus areas — leveraged finance, real estate M&A, and cross-border restructuring. His answers to the case study were sharp, well-structured, and showed genuine market awareness beyond what you typically see at the Analyst level.

Communication and presence: Excellent. Communicates with clarity and maturity. He would represent the team well externally from day one.

Team and culture: Very strong interpersonal skills. He asked thoughtful questions about the team's working culture, showed interest in mentorship, and came across as genuinely collaborative. No concerns whatsoever.

Energy and drive: Kevin showed high energy and genuine enthusiasm throughout the process — he is clearly motivated by the work itself, not just the title.
...
async function main() {
  ...
  const weiFlags = await prisma.flag.createMany({
    data: [
      ...
      // Meeting 3 (Muhammad Azri) — 3 flags, 1 dismissed
      {
        orgId: org.id,
        meetingId: m3.id,
        flagType: 'criteria_drift',
  ...
  await prisma.flag.createMany({
    data: [
      ...
      // Meeting 6 (Nurul) — 3 flags, 1 dismissed
      {
        orgId: org.id,
        meetingId: m6.id,
        flagType: 'asymmetric_concern',
  ...
  await prisma.flag.createMany({
    data: [
      // Meeting 9 (Rajesh — David) — 4 flags, hedging_language
      {
        orgId: org.id,
        meetingId: m9.id,
      ...
      // Meeting 10 (Ravi) — 4 flags, age_bias (1 dismissed)
      {
        orgId: org.id,
        meetingId: m10.id,
        flagType: 'age_bias',
      ...
      // Meeting 11 (Lakshmi — David) — 4 flags, mix age_bias + hedging_language
      {
        orgId: org.id,
        meetingId: m11.id,
        flagType: 'age_bias',
